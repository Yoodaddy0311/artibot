...
[![Version](https://img.shields.io/badge/version-4.51.0-blue?style=flat-square)](./CHANGELOG.md)
...
|---|---|---|
| `version` | `4.51.0` | Synced across plugin.json / package.json / artibot.config.json |
...
- 15개 이벤트에 26개 훅 등록 (HTTP webhook 알림 포함)
