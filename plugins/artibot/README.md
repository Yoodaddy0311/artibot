...
[![Version](https://img.shields.io/badge/version-4.60.0-blue?style=flat-square)](./CHANGELOG.md)
...
|---|---|---|
| `version` | `4.60.0` | Synced across plugin.json / package.json / artibot.config.json |
...
│   └── hooks.json               # 훅 이벤트 매핑
├── scripts/
│   ├── hooks/                   # 71개 훅 스크립트 파일 (.js 64 + .mjs 6, ESM, file-lock 포함)
