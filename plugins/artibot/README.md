...
[![Version](https://img.shields.io/badge/version-4.5.10-blue?style=flat-square)](./CHANGELOG.md)
...
|---|---|---|
| `version` | `4.5.10` | Synced across plugin.json / package.json / artibot.config.json |
