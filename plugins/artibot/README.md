...
[![Version](https://img.shields.io/badge/version-4.48.0-blue?style=flat-square)](./CHANGELOG.md)
...
|---|---|---|
| `version` | `4.48.0` | Synced across plugin.json / package.json / artibot.config.json |
