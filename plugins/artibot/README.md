...
[![Version](https://img.shields.io/badge/version-4.52.0-blue?style=flat-square)](./CHANGELOG.md)
...
|---|---|---|
| `version` | `4.52.0` | Synced across plugin.json / package.json / artibot.config.json |
...
- 16개 이벤트에 26개 훅 등록 (HTTP webhook 알림 포함)
...
│   └── hooks.json               # 훅 이벤트 매핑
├── scripts/
│   ├── hooks/                   # 69개 훅 스크립트 파일 (.js 62 + .mjs 6, ESM, file-lock 포함)
