...
[![Version](https://img.shields.io/badge/version-4.6.4-blue?style=flat-square)](./CHANGELOG.md)
...
|---|---|---|
| `version` | `4.6.4` | Synced across plugin.json / package.json / artibot.config.json |
