...
[![Version](https://img.shields.io/badge/version-4.5.0-blue?style=flat-square)](./CHANGELOG.md)
...
|---|---|---|
| `version` | `4.5.0` | Synced across plugin.json / package.json / artibot.config.json |
...
**v4.5.0 (current, stable)** — Citation formatter (5 modes + lenticular bracket sanitization) + README claims CI validator (PR fast gate / main strict gate). See [CHANGELOG](./CHANGELOG.md).
