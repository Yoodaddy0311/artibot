...
[![Version](https://img.shields.io/badge/version-4.6.2-blue?style=flat-square)](./CHANGELOG.md)
...
|---|---|---|
| `version` | `4.6.2` | Synced across plugin.json / package.json / artibot.config.json |
