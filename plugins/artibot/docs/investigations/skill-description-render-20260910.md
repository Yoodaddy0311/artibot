...
| (b) | `skills/lang-reference/SKILL.md:4`(2,363자 — 2026-09-11 schema-frontmatter 줄기에서 913자/1,076바이트로 축약, polish 는 무접촉), `skills/polish/SKILL.md:15`(1,149자) | 호스트 캡 1,536자 기준이면 lang-reference 만 절단 대상. 사이드 린터 `scripts/ci/lint-skill-descriptions.js:52 MAX_DESC_LEN = 1024`(00:3x 기준) 는 호스트 캡과 기준이 다르다 — 1,536 으로 맞출지는 그 린터 소유자 결정 |
