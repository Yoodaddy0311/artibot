 ...
 *     넘는다**. 실측(node v24.15.0): 리더 11:21 KST 122,880B 규칙 단독
 *     15,018ms · classifyRisk 13,143ms — PreToolUse 예산 5s 초과. 재측정
 *     11:30 KST(중앙값 3회, 회차마다 다른 꼬리) 규칙 단독(L2) 5,633 / 11,265 /
 *     22,529B = 26.3 / 91.3 / 395.0ms (2배마다 3.5~4.3배). 1-b 토큰 교체로는
 *     안 고쳐진다 — 고치려면 규칙 언어가
 *     바뀌므로 리더·오너 결정 몫이다. 이 스캐너와 1-b 검출기는 둘 다 조용하다.
