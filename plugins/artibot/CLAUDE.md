...
| `skills/` | SKILL.md + references/ (98 dirs) | principles/, tdd-workflow/, coding-standards/ |
| `lib/cognitive/` | Dual-process engine | router.js, system1.js, system2-core.js |
| `lib/learning/` | Lifelong learning (15 modules) | grpo.js, memory.js, lifelong.js |
| `lib/core/` | Core utilities (27 files) | plugin-loader.js, hook-utils.js |
...
| `lib/runtime/` | Runtime pipeline (12 files, 9 middlewares) | create-artibot-agent.js, evaluator.js, middleware/ |
...
| `tests/` | Vitest test suite (115 files) | 3,989 test cases |
