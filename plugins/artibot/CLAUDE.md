...
Claude Native Agent Teams API (named `Agent` spawns into the session's single implicit team + SendMessage + TaskCreate family) + 28 agents + 113 skills + 78 commands. ESM only, `"type": "module"`, zero runtime deps, Node >=20.
