...
description: "오늘 하루의 커밋·품질·작업 현황·다음 단계를 구조화된 대시보드로 정리하는 일일 회고 스킬. Use when reviewing daily progress, generating a retrospective, or planning the next actions. Triggers: daily, recap, 회고, 일일 보고, 오늘 작업, 오늘 뭐 했지, retrospective, daily report, 오늘 뭐 했는지 정리해줘, 일일 리뷰 해줘, 오늘 작업 요약해줘"
lang: [en, ko]
