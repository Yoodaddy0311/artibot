...
description: "컴팩션 생존 전략 — 컨텍스트 압축 시 핵심 정보 보존 방법. Auto-activates when: context is about to compact, key files must survive compression, pending work needs to persist. Triggers: compaction, context loss, context compression, 컴팩션, 컨텍스트 손실, 컨텍스트 압축, 컨텍스트 윈도우. See also strategic-compact for compaction timing."
lang: [en, ko]
...
> 현재 정책 티어의 토크나이저(4.7 세대에서 변경)는 동일 텍스트에 더 많은 토큰을 사용할 수 있어 5%p 조기 트리거 필요 (75% → 70%).
