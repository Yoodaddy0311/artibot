...
| "I'll put the logic in the controller, Phoenix is MVC" | Phoenix contexts exist so business logic stays out of controllers and is testable without Plug.Conn. Controllers should be 10 lines or less: parse params, call context, render. |
