...
| "for-loops are fine, I don't need vectorization" | R's for-loops are 10 to 100x slower than vectorized ops because each iteration allocates. Use vapply, purrr::map_*, or dplyr verbs — also type-safe against silent coercion. |
