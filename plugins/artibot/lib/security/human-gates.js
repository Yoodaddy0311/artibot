...
export const HUMAN_GATE_MATRIX = Object.freeze([
  ...
  Object.freeze({
    ...
    existingCoverage: Object.freeze([
      ...
      'lib/autopilot/safety.js DANGEROUS_PATTERNS ids(danger): rm-rf-root · rm-rf-broad · git-force-push · git-force-push-short · git-branch-delete · git-reset-hard · dd-device-write · sql-drop-table · sql-truncate · sql-delete-no-where',
      'lib/autopilot/safety.js DANGEROUS_PATTERNS ids(caution — 차단 아님, 경고만): git-force-push-lease · rm-rf-path',
    ]),
