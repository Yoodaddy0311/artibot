<!--
INDEPENDENT REFERENCE — not derived from fixtures; demonstrates column-editorial skill spec compliance only.
Reference implementation — demonstrates column-editorial skill compliance.
All entities (Dr. Jane Park, Helix Ventures, cited companies, datasets) are fictional.
...
The traditional code review was not primarily a bug-catching mechanism. It was a teaching mechanism that happened to catch bugs. Across Helix's longitudinal panel of 4,200 engineers tracked through the first 24 months of their careers, juniors who received human review comments on at least 60% of their pull requests in their first year scored 31% higher on system-design interviews at month 18 than juniors who did not ([INTERNAL DATA 2026], Helix Career Trajectory Panel 2022-2026). The correlation held after controlling for hiring bar, school, and team size.
...
In the 38 client orgs we track, the adoption curve of AI code review is steep: in 2022, 8% of pull requests had any AI-generated comment; by 2026, 71% did, and the share of PRs receiving a substantive human review dropped from 82% to 43% in the same window ([INTERNAL DATA 2026], Helix Industry Review Mix Survey). Senior engineers are not writing fewer comments because they are lazier. They are writing fewer comments because the AI got there first and the obvious teaching moments are already marked as resolved.
...
I will retract this thesis if longitudinal junior-to-senior promotion data from AI-heavy codebases shows equivalent or higher promotion rates to AI-light codebases within 36 months, measured by the same system-design rubric used at the junior stage. The retraction condition is narrow on purpose — promotion rates, not self-reported learning, not raw tenure — because those are the outcomes the thesis actually predicts. Helix is publishing its 2026-2029 promotion cohort panel in Q2 2029; that dataset will decide this argument, and I will update this column in public if the data runs against me.
...
|---|---|---|
| Juniors with 60%+ human-review exposure score 31% higher at month 18 | Tier 1 | First-party longitudinal panel (Helix 2022-2026) |
| AI review share rose from 8% to 71% of PRs 2022-2026 | Tier 1 | First-party industry survey (Helix 38-org panel) |
