...
[![Version](https://img.shields.io/badge/version-4.5.7-blue?style=flat-square)](plugins/artibot/CHANGELOG.md)
...
|---|---|---|---|
| [`artibot`](./plugins/artibot/) | Claude Code (developer CLI) | **4.5.7** | full Agent Teams orchestration, TDD, code review, security audits, GRPO learning, MCP server |
...
50 hook registrations across 15 event types:
