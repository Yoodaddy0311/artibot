...
[![Version](https://img.shields.io/badge/version-4.7.1-blue?style=flat-square)](plugins/artibot/CHANGELOG.md)
...
|---|---|---|---|
| [`artibot`](./plugins/artibot/) | Claude Code (developer CLI) | **4.7.1** | full Agent Teams orchestration, TDD, code review, security audits, GRPO learning, MCP server, **Goal-driven autopilot**, **`/learning` diagnostics**, **measurement-bug fix + exec-form hooks**, **OTEL agent_id propagation** |
