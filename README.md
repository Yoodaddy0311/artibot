...
[![Version](https://img.shields.io/badge/version-4.7.5-blue?style=flat-square)](plugins/artibot/CHANGELOG.md)
...
- **Forked Context Skills** -- All 109 skills run in isolated forked context for clean execution without cross-contamination
