...
[![Tests](https://img.shields.io/badge/tests-2993%20passed-brightgreen)](plugins/artibot/tests/)
...
1.7.2 -- Branch coverage boost (+60 tests, 83%→91% branch), .gitignore cleanup, persistent team mode, token conservation, inspection mode
