...
[![Version](https://img.shields.io/badge/version-4.5.3-blue?style=flat-square)](plugins/artibot/CHANGELOG.md)
...
|---|---|---|---|
| [`artibot`](./plugins/artibot/) | Claude Code (developer CLI) | **4.5.3** | full Agent Teams orchestration, TDD, code review, security audits, GRPO learning, MCP server |
